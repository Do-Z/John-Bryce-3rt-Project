...
class ImageHandler:
    ...
    def save_image(image):
        ...
        suffix = Path(image.filename).suffix # סיומת קובץ
        image_name = str(uuid4()) + suffix # create unique name
        image_path = Path(current_app.root_path) / "static/images" / image_name # static/images/122323-323wedwewe--32323-wewe.png 
    ...
    def get_image_path(image):
        image_path = Path(current_app.root_path) / "static/images" / image
